...
samtools flagstat --threads 12 ./sorted_mapped_reads_ERR1755082_stats.bam > sorted_mapped_reads_ERR1755082_flagstat
samtools idxstats --threads 12 ./sorted_mapped_reads_ERR1755082_stats.bam > sorted_mapped_reads_ERR1755082_idxstats 
